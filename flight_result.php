...
while($row=mysqli_fetch_array($query1))
 ...
 while($row=mysqli_fetch_array($query2))
    ...
    $tofrom=$iatad.'-'.$iataa;
    $url='https://www.expedia.co.in/Flights-Search?trip=oneway&leg1=from:'.$iataa.',to:'.$iatad.',departure:24/1/2018TANYT&passengers=children:0,adults:1,seniors:0,infantinlap:Y&mode=search';
